 ...
 */
public class MyEventMessageActivity extends Activity implements AutoListView.OnRefreshListener,
        AutoListView.OnLoadListener, ICallback, DeleteInfoDialog.DeleteInfoDialogResult,
        View.OnClickListener {
    private Activity context;
    private MyEventMessageAdapter myOrderMessageAdapter;
    ...
    public void onPause() {
        super.onPause();
        MobclickAgent.onPageEnd("通知活动页面");
