 ...
 */
public class MyOrderMessageActivity extends Activity implements AutoListView.OnRefreshListener,
    ...
    private void loadData(final int what) {
        ...
        MessageListModel.getMyMessage(MessageType.msgType.ORDER.name()).done(this)
                .fail(new ICallback() {
                    @Override
