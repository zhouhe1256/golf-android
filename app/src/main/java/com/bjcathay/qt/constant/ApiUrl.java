 ...
 */
public class ApiUrl {
    public static final String VERSION = SystemUtil.getCurrentVersionName(GApplication
            .getInstance());
    public static final String HOST_URL = GApplication.getInstance().getResources()
            .getString(R.string.host);
    public static final String IMG_HOST_URL = GApplication.getInstance().getResources()
    ...
    public static final String USER_LOGIN = "/api/user/login";// 登录(POST
                                                              // /api/login)
    public static final String USER_INFO = "/api/user";// 获取当前用户信息(GET
                                                       // /api/user)
    public static final String SEND_CHECK_CODE = "/api/user/send_check_code";// 发送验证码(POST
                                                                             // /api/user/send_check_code)
    public static final String VERIFY_CHECK_CODE = "/api/user/verify_check_code";// 检查验证码是否正确(POST
                                                                                 // /api/user/verify_check_code)
    public static final String CHANGE_PASSWORD = "/api/user/change_password";// 修改密码(PUT
                                                                             // /api/user/change_password)
    public static final String RESET_PASSWORD = "/api/user/reset_password";// 修改密码(PUT
                                                                           // /api/user/reset_password)
    public static final String CHANGE_USER_INFO = "/api/user";// 更新用户信息(PUT
                                                              // /api/user)
    public static final String SET_AVATAR = "/api/user/set_avatar";// 设置用户头像(POST
                                                                   // /api/user/set_avatar)
    public static final String USER_SEARCH = "/api/user/search";// 根据用户手机号搜索用户(POST
                                                                // /api/user/search)
    public static final String USER_CONTACT_LIST_SEARCH = "/api/user/list";// 通过手机通讯录查询用户列表(POST
                                                                           // /api/user/list
    public static final String USER_CONTACT_LIST_INVITE = "/api/user/invite";// 获取邀请用户列表(GET
                                                                             // /api/user/invite)

    public static final String MY_EVENT = "/api/user/event";// 我的赛事(GET
                                                            // /api/user/event)
    ...
    public static final String MY_ORDERS = "/api/user/order";// 我的订单(GET
                                                             // /api/user/order)

    public static final String COMMIT_ORDER = "/api/user/order";// 提交订单(POST
                                                                // /api/user/order)
    ...
    public static final String MY_PROPS = "/api/user/prop"; // 我的兑换(GET
                                                            // /api/user/prop)
    public static final String DELETE_EVENTS = "/api/user/event"; // 删除赛事(DELETE
                                                                  // /api/user/event)
    public static final String FEED_BACK = "/api/user/feedback"; // 用户反馈(POST
                                                                 // /api/user/feedback)
    public static final String SHARE_APP = "/api/share/app"; // 分享app(GET
                                                             // /api/share/app)
    public static final String SHARE_PRODUCTS = "/api/share/products"; // 分享产品（只能是团购，特卖和限购）(GET
                                                                       // /api/share/products)
    public static final String SHARE_COMPETITION = "/api/share/competitions"; // 分享赛事
                                                                              // (GET
                                                                              // /api/share/competitions)
    public static final String SHARE_ORDER = "/api/share/orders"; // 分享订单 (GET
                                                                  // /api/share/orders)
    public static final String SOFT_UPDATE = "/api/update"; // 检查更新(GET
                                                            // /api/update)
    public static final String PRODUCT_RESEARCH = "/api/products/search"; // 产品搜索(GET
                                                                          // /api/products/search)
    public static final String GOLF_RESEARCH = "/api/golfCourses"; // 获取球场信息(GET
                                                                   // /api/golfCourses)
