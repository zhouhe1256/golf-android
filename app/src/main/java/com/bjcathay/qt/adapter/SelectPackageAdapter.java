...
public class SelectPackageAdapter extends BaseAdapter {
    ...
    public SelectPackageAdapter(List<ProductModel> items, SelectPackageActivity activity) {
        if (items == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final Holder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_select_package,
                    parent,
                    false);
         ...
         * holder.price.setText(String.valueOf((int)
         * Math.floor(productModel.getPrice())));
         */return convertView;
    }
